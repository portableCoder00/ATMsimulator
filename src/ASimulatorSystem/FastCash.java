...
public class FastCash extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource()==b1){
                    ...
                    ResultSet rs = c1.s.executeQuery(" select * from bank ORDER BY pin = '"+a+"' DESC LIMIT 1");
                    ...
                    ResultSet rs = c1.s.executeQuery(" sselect * from bank ORDER BY pin = '"+a+"' DESC LIMIT 1 ");
